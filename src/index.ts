import type { WujieConfig } from './constant'
import type { lifecycle } from './sandbox'
import type { ScriptAttributes, StyleObject } from './template'
import { addSandboxCacheWithOptions, getOptionsById, getWujieById } from './common'
import { mergeConfig, WUJIE_TIPS_INIT_REPEAT, WUJIE_TIPS_NOT_SUPPORTED } from './constant'
import importHTML, { processCssLoader } from './entry'
import { EventBus } from './event'
import { getPlugins } from './plugin'
import WuJie from './sandbox'
import { addLoading, defineWujieWebComponent } from './shadow'
